...
import '../types/polkadot_runtime_common/claims/pallet/call.dart' as _i9;
...
class Txs {
  ...
  /// </weight>
  _i8.RuntimeCall claim({
    required dest,
    required ethereumSignature,
  }) {
    final _call = _i9.Call.values.claim(
      dest: dest,
      ethereumSignature: ethereumSignature,
    );
    return _i8.RuntimeCall.values.claims(_call);
  }
  ...
  /// Total Complexity: O(1)
  /// </weight>
  _i8.RuntimeCall mintClaim({
    required who,
    required value,
    vestingSchedule,
    statement,
  }) {
    final _call = _i9.Call.values.mintClaim(
      who: who,
      value: value,
  ...
  /// Total Complexity: O(1)
  /// </weight>
  _i8.RuntimeCall claimAttest({
    required dest,
    required ethereumSignature,
    required statement,
  }) {
    final _call = _i9.Call.values.claimAttest(
      dest: dest,
      ethereumSignature: ethereumSignature,
      statement: statement,
    );
  ...
  /// Total Complexity: O(1)
  /// </weight>
  _i8.RuntimeCall attest({required statement}) {
    final _call = _i9.Call.values.attest(statement: statement);
    return _i8.RuntimeCall.values.claims(_call);
  }

  _i8.RuntimeCall moveClaim({
    required old,
    required new_,
    maybePreclaim,
  }) {
    final _call = _i9.Call.values.moveClaim(
      old: old,
      new_: new_,
