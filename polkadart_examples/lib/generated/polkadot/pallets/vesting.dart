...
class Txs {
  ...
  /// ## Complexity
  /// - `O(1)`.
  _i7.RuntimeCall vest() {
    final _call = _i8.Call.values.vest();
    return _i7.RuntimeCall.values.vesting(_call);
  }
  ...
  /// ## Complexity
  /// - `O(1)`.
  _i7.RuntimeCall vestOther({required target}) {
    final _call = _i8.Call.values.vestOther(target: target);
    return _i7.RuntimeCall.values.vesting(_call);
  }
  ...
  /// ## Complexity
  /// - `O(1)`.
  _i7.RuntimeCall vestedTransfer({
    required target,
    required schedule,
  }) {
    final _call = _i8.Call.values.vestedTransfer(
      target: target,
      schedule: schedule,
    );
    return _i7.RuntimeCall.values.vesting(_call);
  ...
  /// ## Complexity
  /// - `O(1)`.
  _i7.RuntimeCall forceVestedTransfer({
    required source,
    required target,
    required schedule,
  }) {
    final _call = _i8.Call.values.forceVestedTransfer(
      source: source,
      target: target,
      schedule: schedule,
    );
  ...
  _i7.RuntimeCall mergeSchedules({
    required schedule1Index,
    required schedule2Index,
  }) {
    final _call = _i8.Call.values.mergeSchedules(
