...
import '../types/pallet_referenda/pallet/call.dart' as _i8;
import '../types/pallet_referenda/types/curve.dart' as _i10;
import '../types/pallet_referenda/types/referendum_info.dart' as _i3;
import '../types/pallet_referenda/types/track_info.dart' as _i9;
...
class Txs {
  ...
  ///
  /// Emits `Submitted`.
  _i7.RuntimeCall submit({
    required proposalOrigin,
    required proposal,
    required enactmentMoment,
  }) {
    final _call = _i8.Call.values.submit(
      proposalOrigin: proposalOrigin,
      proposal: proposal,
      enactmentMoment: enactmentMoment,
    );
    return _i7.RuntimeCall.values.referenda(_call);
  }
  ...
  _i7.RuntimeCall placeDecisionDeposit({required index}) {
    final _call = _i8.Call.values.placeDecisionDeposit(index: index);
    return _i7.RuntimeCall.values.referenda(_call);
  }
  ...
  _i7.RuntimeCall refundDecisionDeposit({required index}) {
    final _call = _i8.Call.values.refundDecisionDeposit(index: index);
    return _i7.RuntimeCall.values.referenda(_call);
  }
  ...
  ///
  /// Emits `Cancelled`.
  _i7.RuntimeCall cancel({required index}) {
    final _call = _i8.Call.values.cancel(index: index);
    return _i7.RuntimeCall.values.referenda(_call);
  }
  ...
  _i7.RuntimeCall kill({required index}) {
    final _call = _i8.Call.values.kill(index: index);
    return _i7.RuntimeCall.values.referenda(_call);
  }
  ...
  _i7.RuntimeCall nudgeReferendum({required index}) {
    final _call = _i8.Call.values.nudgeReferendum(index: index);
    return _i7.RuntimeCall.values.referenda(_call);
  }
  ...
  _i7.RuntimeCall oneFewerDeciding({required track}) {
    final _call = _i8.Call.values.oneFewerDeciding(track: track);
    return _i7.RuntimeCall.values.referenda(_call);
  }
  ...
  _i7.RuntimeCall refundSubmissionDeposit({required index}) {
    final _call = _i8.Call.values.refundSubmissionDeposit(index: index);
    return _i7.RuntimeCall.values.referenda(_call);
  }
...
class Constants {
  ...
  final List<_i4.Tuple2<int, _i9.TrackInfo>> tracks = [
    _i4.Tuple2<int, _i9.TrackInfo>(
      0,
      _i9.TrackInfo(
        name: 'root',
        maxDeciding: 1,
    ...
    _i4.Tuple2<int, _i9.TrackInfo>(
      ...
      _i9.TrackInfo(
        ...
        confirmPeriod: 1800,
        minEnactmentPeriod: 100,
        minApproval: const _i10.LinearDecreasing(
          length: 607142857,
          floor: 500000000,
          ceil: 1000000000,
        ),
