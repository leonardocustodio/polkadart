...
import '../types/pallet_conviction_voting/pallet/call.dart' as _i11;
...
class Txs {
  ...
  _i10.RuntimeCall vote({
    ...
    return _i10.RuntimeCall.values.convictionVoting(_call);
  }
  ...
  _i10.RuntimeCall delegate({
    required class_,
    required to,
    required conviction,
    required balance,
  }) {
    final _call = _i11.Call.values.delegate(
      class_: class_,
      to: to,
  ...
  /// Weight: `O(R)` where R is the number of polls the voter delegating to has
  ///  voted on. Weight is initially charged as if maximum votes, but is refunded later.
  _i10.RuntimeCall undelegate({required class_}) {
    final _call = _i11.Call.values.undelegate(class_: class_);
    return _i10.RuntimeCall.values.convictionVoting(_call);
  }
  ...
  _i10.RuntimeCall unlock({
    required class_,
    required target,
  }) {
    final _call = _i11.Call.values.unlock(
      class_: class_,
      target: target,
    );
    return _i10.RuntimeCall.values.convictionVoting(_call);
  ...
  _i10.RuntimeCall removeVote({
    class_,
    required index,
  }) {
    final _call = _i11.Call.values.removeVote(
      class_: class_,
      index: index,
    );
    return _i10.RuntimeCall.values.convictionVoting(_call);
  ...
  /// Weight: `O(R + log R)` where R is the number of polls that `target` has voted on.
  ///  Weight is calculated for the maximum number of vote.
  _i10.RuntimeCall removeOtherVote({
    required target,
    required class_,
    required index,
  }) {
    final _call = _i11.Call.values.removeOtherVote(
      target: target,
      class_: class_,
      index: index,
    );
