...
import '../types/pallet_child_bounties/pallet/call.dart' as _i6;
...
class Txs {
  ...
  _i5.RuntimeCall addChildBounty({
    required parentBountyId,
    required value,
    required description,
  }) {
    final _call = _i6.Call.values.addChildBounty(
      parentBountyId: parentBountyId,
      value: value,
      description: description,
    );
    return _i5.RuntimeCall.values.childBounties(_call);
  }
  ...
  /// - `parent_bounty_id`: Index of parent bounty.
  /// - `child_bounty_id`: Index of child bounty.
  _i5.RuntimeCall acceptCurator({
    required parentBountyId,
    required childBountyId,
  }) {
    final _call = _i6.Call.values.acceptCurator(
      parentBountyId: parentBountyId,
      childBountyId: childBountyId,
    );
    return _i5.RuntimeCall.values.childBounties(_call);
  ...
  /// - `parent_bounty_id`: Index of parent bounty.
  /// - `child_bounty_id`: Index of child bounty.
  _i5.RuntimeCall unassignCurator({
    required parentBountyId,
    required childBountyId,
  }) {
    final _call = _i6.Call.values.unassignCurator(
      parentBountyId: parentBountyId,
      childBountyId: childBountyId,
    );
    return _i5.RuntimeCall.values.childBounties(_call);
  ...
  _i5.RuntimeCall awardChildBounty({
    required parentBountyId,
    required childBountyId,
    required beneficiary,
  }) {
    final _call = _i6.Call.values.awardChildBounty(
      parentBountyId: parentBountyId,
      childBountyId: childBountyId,
  ...
  /// - `parent_bounty_id`: Index of parent bounty.
  /// - `child_bounty_id`: Index of child bounty.
  _i5.RuntimeCall claimChildBounty({
    required parentBountyId,
    required childBountyId,
  }) {
    final _call = _i6.Call.values.claimChildBounty(
      parentBountyId: parentBountyId,
      childBountyId: childBountyId,
    );
    return _i5.RuntimeCall.values.childBounties(_call);
  ...
  /// - `parent_bounty_id`: Index of parent bounty.
  /// - `child_bounty_id`: Index of child bounty.
  _i5.RuntimeCall closeChildBounty({
    required parentBountyId,
    required childBountyId,
  }) {
    final _call = _i6.Call.values.closeChildBounty(
      parentBountyId: parentBountyId,
      childBountyId: childBountyId,
    );
    return _i5.RuntimeCall.values.childBounties(_call);
