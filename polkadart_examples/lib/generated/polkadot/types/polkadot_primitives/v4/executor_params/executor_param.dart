...
import '../pvf_exec_timeout_kind.dart' as _i4;
import '../pvf_prep_timeout_kind.dart' as _i3;
...
class PvfPrepTimeout extends ExecutorParam {
  ...
  factory PvfPrepTimeout._decode(_i1.Input input) {
    return PvfPrepTimeout(
      _i3.PvfPrepTimeoutKind.codec.decode(input),
      _i1.U64Codec.codec.decode(input),
    );
  }

  /// PvfPrepTimeoutKind
  final _i3.PvfPrepTimeoutKind value0;
  ...
  int _sizeHint() {
    int size = 1;
    size = size + _i3.PvfPrepTimeoutKind.codec.sizeHint(value0);
  ...
  void encodeTo(_i1.Output output) {
    ...
    _i3.PvfPrepTimeoutKind.codec.encodeTo(
      value0,
      output,
    );
    _i1.U64Codec.codec.encodeTo(
...
class PvfExecTimeout extends ExecutorParam {
  ...
  factory PvfExecTimeout._decode(_i1.Input input) {
    return PvfExecTimeout(
      _i4.PvfExecTimeoutKind.codec.decode(input),
      _i1.U64Codec.codec.decode(input),
    );
  }

  /// PvfExecTimeoutKind
  final _i4.PvfExecTimeoutKind value0;
  ...
  int _sizeHint() {
    int size = 1;
    size = size + _i4.PvfExecTimeoutKind.codec.sizeHint(value0);
    size = size + _i1.U64Codec.codec.sizeHint(value1);
    return size;
  }
  ...
  void encodeTo(_i1.Output output) {
    ...
    _i4.PvfExecTimeoutKind.codec.encodeTo(
      value0,
      output,
    );
    _i1.U64Codec.codec.encodeTo(
