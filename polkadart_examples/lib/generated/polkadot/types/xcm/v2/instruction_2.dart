...
import '../double_encoded/double_encoded_2.dart' as _i8;
import 'instruction_1.dart' as _i15;
import 'instruction_2.dart' as _i16;
...
class $Instruction {
  ...
  SetAppendix setAppendix(_i13.Xcm value0) {
...
class TransferReserveAsset extends Instruction {
  ...
  factory TransferReserveAsset._decode(_i1.Input input) {
    return TransferReserveAsset(
      ...
      xcm: const _i1.SequenceCodec<_i15.Instruction>(_i15.Instruction.codec)
          .decode(input),
    );
  }
  ...
  void encodeTo(_i1.Output output) {
    ...
    const _i1.SequenceCodec<_i15.Instruction>(_i15.Instruction.codec).encodeTo(
      xcm,
      output,
    );
  }
...
class SetErrorHandler extends Instruction {
  ...
  factory SetErrorHandler._decode(_i1.Input input) {
    return SetErrorHandler(
        const _i1.SequenceCodec<_i16.Instruction>(_i16.Instruction.codec)
            .decode(input));
  }

  /// Xcm<RuntimeCall>
  final _i13.Xcm value0;
  ...
  int _sizeHint() {
    int size = 1;
    size = size + const _i13.XcmCodec().sizeHint(value0);
    return size;
  }
  ...
  void encodeTo(_i1.Output output) {
    ...
    const _i1.SequenceCodec<_i16.Instruction>(_i16.Instruction.codec).encodeTo(
      value0,
      output,
    );
  }
