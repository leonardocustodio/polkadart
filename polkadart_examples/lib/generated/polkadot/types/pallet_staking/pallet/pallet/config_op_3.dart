...
import '../../../sp_arithmetic/per_things/percent.dart' as _i3;
...
class Set extends ConfigOp {
  ...
  factory Set._decode(_i1.Input input) {
    return Set(_i1.U8Codec.codec.decode(input));
  }

  /// T
  final _i3.Percent value0;
  ...
  int _sizeHint() {
    int size = 1;
    size = size + const _i3.PercentCodec().sizeHint(value0);
    return size;
  }
