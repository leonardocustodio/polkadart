...
import '../../forcing.dart' as _i6;
import '../../validator_prefs.dart' as _i5;
...
class $Event {
  ...
  ValidatorPrefsSet validatorPrefsSet({
    required _i3.AccountId32 stash,
    required _i5.ValidatorPrefs prefs,
  }) {
  ...
  ForceEra forceEra({required _i6.Forcing mode}) {
...
class SlashReported extends Event {
  ...
  int _sizeHint() {
    ...
    size = size + const _i4.PerbillCodec().sizeHint(fraction);
...
class ValidatorPrefsSet extends Event {
  ...
  factory ValidatorPrefsSet._decode(_i1.Input input) {
    return ValidatorPrefsSet(
      stash: const _i1.U8ArrayCodec(32).decode(input),
      prefs: _i5.ValidatorPrefs.codec.decode(input),
    );
  }
  ...
  /// ValidatorPrefs
  final _i5.ValidatorPrefs prefs;
  ...
  int _sizeHint() {
    int size = 1;
    size = size + const _i3.AccountId32Codec().sizeHint(stash);
    size = size + _i5.ValidatorPrefs.codec.sizeHint(prefs);
    return size;
  }
  ...
  void encodeTo(_i1.Output output) {
    ...
    _i5.ValidatorPrefs.codec.encodeTo(
      prefs,
      output,
    );
  }
...
class ForceEra extends Event {
  ...
  factory ForceEra._decode(_i1.Input input) {
    return ForceEra(mode: _i6.Forcing.codec.decode(input));
  }

  /// Forcing
  final _i6.Forcing mode;
  ...
  int _sizeHint() {
    int size = 1;
    size = size + _i6.Forcing.codec.sizeHint(mode);
    return size;
  }
