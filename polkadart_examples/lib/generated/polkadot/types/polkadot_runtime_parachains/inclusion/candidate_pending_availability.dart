...
import '../../polkadot_primitives/v4/candidate_descriptor.dart' as _i4;
...
class CandidatePendingAvailability {
  ...
  /// GroupIndex
  final _i5.GroupIndex backingGroup;
...
class $CandidatePendingAvailabilityCodec
  ...
  int sizeHint(CandidatePendingAvailability obj) {
    ...
    size = size + const _i5.GroupIndexCodec().sizeHint(obj.backingGroup);
    return size;
  }
}
