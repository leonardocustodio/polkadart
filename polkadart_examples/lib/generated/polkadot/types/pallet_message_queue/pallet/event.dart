...
class $Event {
  ...
  ProcessingFailed processingFailed({
    ...
    required _i3.AggregateMessageOrigin origin,
...
class ProcessingFailed extends Event {
  ...
  factory ProcessingFailed._decode(_i1.Input input) {
    return ProcessingFailed(
      ...
      origin: _i3.AggregateMessageOrigin.codec.decode(input),
  ...
  /// MessageOriginOf<T>
  final _i3.AggregateMessageOrigin origin;
  ...
  int _sizeHint() {
    ...
    size = size + _i3.AggregateMessageOrigin.codec.sizeHint(origin);
  ...
  void encodeTo(_i1.Output output) {
    ...
    _i3.AggregateMessageOrigin.codec.encodeTo(
      origin,
      output,
    );
