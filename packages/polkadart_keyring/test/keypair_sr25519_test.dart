...
void main() {
  group('Sr25519 test cases', () {
    ...
    test('test //9007199254740991', () async {
      expect(
        (await keyring.fromUri('//9007199254740991')).address,
        '5CDsyNZyqxLpHnTvknr68anUcYoBFjZbFKiEJJf4prB75Uog',
      );
    });
    test('test //900719925474099999', () async {
      expect(
        (await keyring.fromUri('//900719925474099999')).address,
    ...
    test('test //Alice via dev seed (2-byte encoding)', () async {
      ...
      expect(
        keyPair.address,
        'xw8P6urbSAronL3zZFB7dg8p7LLSgKCUFDUgjohnf1iP434ic',
      );
    });
    ...
    test('test adds from a mnemonic', () async {
      ...
      expect(
        keyPair.address,
        'FSjXNRT2K1R5caeHLPD6WMrqYUpfGZB7ua8W89JFctZ1YqV',
      );
    });
