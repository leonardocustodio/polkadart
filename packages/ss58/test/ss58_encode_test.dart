...
import 'package:ss58/src/exceptions.dart' show InvalidPrefixException, BadAddressLengthException;
...
void main() {
  group('SS58Codec encode method', () {
    ...
    test('Should encode and return correct address', () {
      ...
      final String encodedAddress = Address(prefix: prefix, pubkey: bytes).encode();

      expect(encodedAddress, expectedEncodedAddress);
    });
  });
  group('SS58Codec encode exception', () {
    test('Should throw InvalidPrefixException when an address has negative prefix', () {
      final addressWithNegativePrefix = Address(prefix: -1, pubkey: Uint8List.fromList([]));
    ...
    test('Should throw BadAddressLengthException when an address bytes length is equal to 5.', () {
    ...
    test('Should throw BadAddressLengthException when an address bytes length is equal to 6.', () {
    ...
    test('Should throw BadAddressLengthException when an address bytes length is equal to 7.', () {
    ...
    test('Should throw BadAddressLengthException when an address bytes length is equal to 9.', () {
    ...
    test('Should throw BadAddressLengthException when an address bytes length is equal to 31.', () {
    ...
    test('Should throw BadAddressLengthException when an address bytes length is equal to 35.', () {
