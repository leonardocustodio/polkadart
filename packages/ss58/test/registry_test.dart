...
void main() {
  ...
  test('Should return a Registry instance when default constructor is called', () {
    final item = RegistryItem.fromJson({"prefix": 0, "network": "polkadot"});
  ...
  test('Should throw DuplicatePrefixException when items list has items with same network', () {
    ...
    final item2 = RegistryItem.fromJson({"prefix": 15, "network": "polkadot"});
  ...
  test('Should return a Registry instance when factory fromMap is called', () {
