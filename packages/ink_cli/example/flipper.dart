...
class Contract {
  ...
  static Future<InstantiateRequest> new_contract({
    ...
    required final ContractDeployer deployer,final Map<String, dynamic> extraOptions = const <String, dynamic>{},
  ...
  ///
  ///  Flips the current value of the Flipper's boolean.
  Future<dynamic> flip({required final KeyPair keyPair, required final ContractMutator mutator, BigInt? storageDepositLimit, GasLimit? gasLimit, final dynamic tip = 0, final int eraPeriod = 0}) async {
