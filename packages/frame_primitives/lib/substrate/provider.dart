...
abstract class Provider {
  ...
  Future<List<Uint8List?>> queryStorage(List<Uint8List> keys, { Uint8List? block });
...
class WsProvider extends Provider {
  ...
  @override
  Future<List<Uint8List?>> queryStorage(List<Uint8List> keys, { Uint8List? block }) async {
    final result = await send("state_getStorage", <String>['0x${HEX.encode(keys.first)}']);
