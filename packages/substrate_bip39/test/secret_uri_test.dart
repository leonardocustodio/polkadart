import 'package:substrate_bip39/secret_uri.dart' show SecretUri, DeriveJunction;
import 'package:test/test.dart';

void main() {
  test('interpret std secret string', () async {
    expect(
        SecretUri.fromStr('hello world'), SecretUri('hello world', null, []));
    ...
    expect(
        SecretUri.fromStr(
            'hello world/0123456789012345678901234567890123456789'),
