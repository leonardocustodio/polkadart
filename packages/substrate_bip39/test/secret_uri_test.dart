...
void main() {
  test('interpret std secret string', () async {
    ...
    expect(
      SecretUri.fromStr('hello world/1'),
      SecretUri('hello world', null, [DeriveJunction.fromStr('1')]),
    );

    expect(
      SecretUri.fromStr('hello world/DOT'),
    ...
    expect(
      ...
      SecretUri('hello world', null, [DeriveJunction.fromStr('/1'), DeriveJunction.fromStr('DOT')]),
    );

    expect(
      SecretUri.fromStr('hello world//DOT/1'),
      SecretUri('hello world', null, [DeriveJunction.fromStr('/DOT'), DeriveJunction.fromStr('1')]),
    );
