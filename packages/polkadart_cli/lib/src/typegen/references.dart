...
const compactBigIntCodec = Reference(
  'CompactBigIntCodec',
  'package:polkadart_scale_codec/polkadart_scale_codec.dart',
);
const bitSequenceCodec = Reference(
  'BitSequenceCodec',
  'package:polkadart_scale_codec/polkadart_scale_codec.dart',
);
...
const storageHasher = Reference(
  'StorageHasher',
  'package:substrate_metadata/substrate_metadata.dart',
);
