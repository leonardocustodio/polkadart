...
const addrIndicesTypes = <String, dynamic>{
...
const addrAccountIdTypes = <String, dynamic>{
  'AccountInfo': 'AccountInfoWithRefCount',
  'Address': 'AccountId',
  'CompactAssignments': 'CompactAssignmentsWith16',
  'RawSolution': 'RawSolutionWith16',
...
Map<String, String> mapXcmTypes(String version) {
...
final bundle = <String, dynamic>{
  ...
  'versions': [
    ...
    {
      'minmax': [9010, 9099],
      'types': {...sharedTypes, ...mapXcmTypes('V0')}
    },
    {
      // jump from 9100 to 9110, however align with Rococo
      'minmax': [9100, 9105],
      'types': {...sharedTypes, ...mapXcmTypes('V1')}
    },
    {
      // metadata v14
      'minmax': [9106, null],
