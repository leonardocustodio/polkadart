...
const bridgeEos = <String, dynamic>{
  'VersionId': 'u32',
  'PermissionName': 'u64',
...
const bridgeIost = <String, dynamic>{
  'IostAction': {
    'contract': 'Vec<u8>',
    'action_name': 'Vec<u8>',
    'data': 'Vec<u8>'
...
const flexibleFee = <String, dynamic>{
...
const minterReward = <String, String>{
  'IsExtended': 'bool',
  'SystemPalletId': 'PalletId',
};

const salp = <String, dynamic>{
  'TrieIndex': 'u32',
  'FundInfo': {
    'raised': 'Balance',
    'cap': 'Balance',
...
const stakingReward = <String, dynamic>{
  'RewardRecord': {
...
const vsBondAuction = <String, dynamic>{
  'OrderInfo': {
    'owner': 'AccountIdOf',
    'vsbond': 'CurrencyId',
    'amount': 'BalanceOf',
...
const zenlinkProtocol = <String, dynamic>{
  'ZenlinkAssetId': {
    'chain_id': 'u32',
    'asset_type': 'u8',
    'asset_index': 'u64',
...
const liquidityMining = <String, dynamic>{
  'PoolId': 'u32',
  'PoolInfo': {
    'pool_id': 'PoolId',
    'keeper': 'AccountId',
...
const TokenSymbol = <String, dynamic>{
  '_enum': ['ASG', 'BNC', 'KUSD', 'DOT', 'KSM', 'KAR', 'ZLK', 'PHA', 'RMRK'],
};

const xcmV0 = <String, String>{
