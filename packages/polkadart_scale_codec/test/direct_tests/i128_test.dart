...
void main() {
  group('I128 Decode Test:', () {
    test('Lowest value decoding', () {
      final input = HexInput('0x00000000000000000000000000000080');
      final decoded = I128Codec.instance.decode(input);
    ...
    test('Highest value decoding', () {
      final input = HexInput('0xffffffffffffffffffffffffffffff7f');
      final decoded = I128Codec.instance.decode(input);
