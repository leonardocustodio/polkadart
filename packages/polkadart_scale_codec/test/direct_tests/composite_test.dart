...
void main() {
  group('Composite Encode Test', () {
    test(
      'When value {"a": 42, "b": true} is encoded then it returns 0x2a01',
      () {
        final output = HexOutput();
        CompositeCodec({
          'a': U8Codec.codec,
          'b': BoolCodec.codec,
        }).encodeTo({'a': 42, 'b': true}, output);
  ...
  group('Composite Decode Test', () {
    test(
      'When value 0x2a01 is decoded then it returns {"a": 42, "b": true}',
      () {
