...
void main() {
  group('encode to hex signed int tests', () {
    ...
    group('fixed-length 8bit', () {
      ...
      test(
          ...
          () {
        final smallestSupportedValue = -128;
        String expectedResult = '0x80';

        int registryIndex = registry.getIndex('i8');

        expect(codec.encodeToHex(registryIndex, smallestSupportedValue),
            expectedResult);
      });
      ...
      test(
          ...
          () {
        final largestSupportedValue = 127;
    ...
    group('fixed-length 16bit', () {
      ...
      test(
          ...
          () {
        final smallestSupportedValue = -32768;
      ...
      test(
          ...
          () {
        final largestSupportedValue = 32767;
    ...
    group('fixed-length 32bit', () {
      ...
      test(
          ...
          () {
        final smallestSupportedValue = -2147483648;
      ...
      test(
          ...
          () {
        final largestSupportedValue = 2147483647;
    ...
    group('fixed-length 64bit', () {
      ...
      test(
          ...
          () {
        final smallestSupportedValue = BigInt.from(-9223372036854775808);
      ...
      test(
          ...
          () {
        final largestSupportedValue = BigInt.parse('9223372036854775807');
  ...
  group('decode from hex and return signed int tests', () {
    final typesRegistry = <String, dynamic>{
      'Codec': {
        'a': 'i8',
        'b': 'i16',
    ...
    group('fixed-length 8bit', () {
      ...
      test('Given an encoded string `0x00` it should return zero', () {
        const value = '0x00';
      ...
      test('Given an encoded string `0x80` it should return -128', () {
        const value = '0x80';
      ...
      test('Given an encoded string `0x7f` it should return 127', () {
        const value = '0x7f';
    ...
    group('fixed-length 16bit', () {
      ...
      test(
          'Given an encoded string with length > 6 it should throw UnprocessedDataLeftException',
          () {
