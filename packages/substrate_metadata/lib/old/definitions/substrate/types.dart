...
///
/// Referenced from: https://github.com/subsquid/squid/blob/a63118033545063130359318410ee56e3778a37a/substrate-metadata/src/old/definitions/substrate/types.ts#L1
...
const substrateTypes = {
  ...
  'MoreAttestations': {},
  'RawAuraPreDigest': {'slotNumber': 'u64'},
  'ExtrinsicOrHash': {
    '_enum': {'Hash': 'Hash', 'Extrinsic': 'Bytes'}
  },
  'ExtrinsicStatus': {
    '_enum': {
      'Future': 'Null',
  ...
  'CollectiveOrigin': {
    '_enum': {'Members': '(MemberCount, MemberCount)', 'Member': 'AccountId'}
  },
  'MemberCount': 'u32',
  'ProposalIndex': 'u32',
  'VotesTo230': {
  ...
  'ContractExecResultResult': {
    '_enum': {'Ok': 'ContractExecResultOk', 'Err': 'ContractExecResultErr'}
  },
  ...
  'ExecReturnValue': {'flags': 'u32', 'data': 'Bytes'},
  'Gas': 'u64',
  'HostFnWeightsTo264': {
    'caller': 'Weight',
    'address': 'Weight',
  ...
  'ContractInstantiateResultTo267': {
    '_enum': {'Ok': 'InstantiateReturnValueTo267', 'Err': 'Null'}
  },
  'ContractInstantiateResult': {
    '_enum': {'Ok': 'InstantiateReturnValue', 'Err': 'Null'}
  },
  ...
  'ContractMetadata': {
    '_enum': {'V0': 'ContractMetadataV0', 'V1': 'ContractMetadataV1'}
  },
  ...
  'AccountVote': {
    '_enum': {'Standard': 'AccountVoteStandard', 'Split': 'AccountVoteSplit'}
  },
  ...
  'PreimageStatus': {
    '_enum': {'Missing': 'BlockNumber', 'Available': 'PreimageStatusAvailable'}
  },
  ...
  'Proposal': 'Call',
  'ProxyState': {
    '_enum': {'Open': 'AccountId', 'Active': 'AccountId'}
  },
  'ReferendumIndex': 'u32',
  'ReferendumInfoTo239': {
    'end': 'BlockNumber',
  ...
  'TransactionV1': {
    '_enum': {'Legacy': 'LegacyTransaction', 'EIP2930': 'EIP2930Transaction'}
  },
  'BlockV2': {
    'header': 'EthHeader',
  ...
  'EthSubParams': {
    '_enum': {'None': 'Null', 'Logs': 'EthFilter'}
  },
  'EthSubResult': {
    '_enum': {
  ...
  'EthSyncStatus': {
    '_enum': {'Info': 'EthSyncInfo', 'None': 'Null'}
  },
  'EthTransaction': 'LegacyTransaction',
  'EthTransactionSignature': {'v': 'u64', 'r': 'H256', 's': 'H256'},
  'EthTransactionAction': {
    '_enum': {'Call': 'H160', 'Create': 'Null'}
  },
  'EthTransactionCondition': {
    '_enum': {'block': 'u64', 'time': 'u64'}
  },
  ...
  'AuthorityWeight': 'u64',
  'DelayKind': {
    '_enum': {'Finalized': 'Null', 'Best': 'DelayKindBest'}
  },
  ...
  'MmrLeafProof': {'blockHash': 'BlockHash', 'leaf': 'Bytes', 'proof': 'Bytes'},
  'StorageKind': {
    '_enum': {'PERSISTENT': 1, 'LOCAL': 2}
  },
  ...
  'SeatHolder': {'who': 'AccountId', 'stake': 'Balance', 'deposit': 'Balance'},
  'SignedSubmission': {
    'who': 'AccountId',
    'deposit': 'Balance',
  ...
  'RuntimeVersionPartial': {'specName': 'Text', 'specVersion': 'u32'},
  'SpecVersion': 'u32',
  ...
  'Key': 'Bytes',
  'LastRuntimeUpgradeInfo': {'specVersion': 'Compact<u32>', 'specName': 'Text'},
  'NetworkState': {
    'peerId': 'Text',
  ...
  'PeerEndpointAddr': {'localAddr': 'Text', 'sendBackAddr': 'Text'},
  ...
  'BountyStatusActive': {'curator': 'AccountId', 'updateDue': 'BlockNumber'},
  ...
  'InstructionV2': {
    '_enum': {
      ...
      'BuyExecution': {'fees': 'MultiAssetV2', 'weightLimit': 'WeightLimitV2'},
      'RefundSurplus': 'Null',
