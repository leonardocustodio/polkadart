  ...
  return [
    ...
    },
    {
      ...
      'event': MapEntry(
          ...
          MapEntry('KilledAccount', {
            'T::AccountId': [39,1,121,180,145,97,33,125,209,76,69,114,176,251,190,209,143,25,116,175,82,248,124,94,198,230,252,214,24,77,149,45
            ]
          })),
      'topics': []
    },
    ...
    },
    {
      ...
      'event': MapEntry(
          'Balances',
          MapEntry('Transfer', [
            [39,1,121,180,145,97,33,125,209,76,69,114,176,251,190,209,143,25,116,175,82,248,124,94,198,230,252,214,24,77,149,45
            ],
            [87,104,14,147,249,214,11,155,228,39,189,159,124,91,106,254,109,58,211,208,147,114,189,227,16,58,108,37,149,160,104,92
            ],
    ...
    },
    {
      ...
      'event': MapEntry(
          'Balances',
          MapEntry('Reserved', {
            'T::AccountId': [20,221,65,34,36,89,213,33,233,217,207,21,199,52,106,188,178,178,19,125,177,146,103,115,237,35,3,76,8,9,233,61
            ],
    ...
    },
    {
      ...
      'event': MapEntry(
          'System',
          MapEntry('KilledAccount', {
            'T::AccountId': [186,39,175,206,17,155,132,53,0,241,190,147,218,116,193,95,64,152,51,97,240,69,238,88,53,123,110,22,125,169,229,60
            ]
          })),
      'topics': []
    },
    ...
    },
    {
      ...
      'event': MapEntry(
          'Balances',
          MapEntry('Transfer', [
            [186,39,175,206,17,155,132,53,0,241,190,147,218,116,193,95,64,152,51,97,240,69,238,88,53,123,110,22,125,169,229,60
            ],
            [87,104,14,147,249,214,11,155,228,39,189,159,124,91,106,254,109,58,211,208,147,114,189,227,16,58,108,37,149,160,104,92
            ],
