...
void main() {
  group('Kusama Extrinsics Test', () {
    ...
    parseBlockList(RawBlockExtrinsics.readBlocksFromPath('../../chain/kusama/blocks.part1.jsonl'));
    parseBlockList(RawBlockExtrinsics.readBlocksFromPath('../../chain/kusama/blocks.part2.jsonl'));
    parseBlockList(RawBlockExtrinsics.readBlocksFromPath('../../chain/kusama/blocks.part3.jsonl'));
    parseBlockList(RawBlockExtrinsics.readBlocksFromPath('../../chain/kusama/blocks.part4.jsonl'));
    parseBlockList(RawBlockExtrinsics.readBlocksFromPath('../../chain/kusama/blocks.part5.jsonl'));
    parseBlockList(RawBlockExtrinsics.readBlocksFromPath('../../chain/kusama/blocks.part6.jsonl'));
    parseBlockList(RawBlockExtrinsics.readBlocksFromPath('../../chain/kusama/blocks.part7.jsonl'));
    parseBlockList(RawBlockExtrinsics.readBlocksFromPath('../../chain/kusama/blocks.part8.jsonl'));
    parseBlockList(RawBlockExtrinsics.readBlocksFromPath('../../chain/kusama/blocks.part9.jsonl'));
    parseBlockList(RawBlockExtrinsics.readBlocksFromPath('../../chain/kusama/blocks.part10.jsonl'));
    parseBlockList(RawBlockExtrinsics.readBlocksFromPath('../../chain/kusama/blocks.part11.jsonl'));
  });
}
