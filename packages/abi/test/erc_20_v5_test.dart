...
void main() {
  ...
  test('decode event', () {
    ...
    final decoded = abi.decodeEventFromHex(data, topics);
  ...
  test('decode message', () {
    ...
    final decoded = abi.decodeMessage(data);
