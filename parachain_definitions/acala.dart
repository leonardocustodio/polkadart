...
const additionalOverride = <String, String>{'Keys': 'SessionKeys1'};

const primitives = <String, dynamic>{
  'Amount': 'i128',
  'AmountOf': 'Amount',
  'AuctionId': 'u32',
  ...
  'DexShare': {
    '_enum': {'Token': 'TokenSymbol', 'Erc20': 'EvmAddress'}
  },
  'CurrencyId': {
    '_enum': {
      'Token': 'TokenSymbol',
...
const accounts = <String, String>{'PalletBalanceOf': 'Balance'};

const auctionManager = <String, dynamic>{
...
const cdpEngine = <String, dynamic>{
  'LiquidationStrategy': {
  ...
  'ChangeBalance': {
    '_enum': {'NoChange': 'Null', 'NewValue': 'Balance'}
  },
...
const collatorSelection = <String, dynamic>{'CandidateInfoOf': 'CandidateInfo'};

const dex = <String, dynamic>{
...
const homa = <String, dynamic>{
  'AcalaStakingLedge': {
    'bonded': 'Compact<Balance>',
    'unlocking': 'Vec<UnlockChunk>'
  },
  'AcalaUnlockChunk': {'value': 'Compact<Balance>', 'era': 'Compact<EraIndex>'}
};

const homaValidatorList = <String, dynamic>{
...
const incentives = <String, dynamic>{
  'PoolId': {
...
const loans = <String, dynamic>{
  'Position': {'collateral': 'Balance', 'debit': 'Balance'}
};

const nft = <String, dynamic>{
  'CID': 'Vec<u8>',
  'Attributes': 'BTreeMap<Vec<u8>, Vec<u8>>',
  'TokenInfoOf': {'metadata': 'CID', 'owner': 'AccountId', 'data': 'TokenData'},
  'Properties': {
    '_set': {'_bitLength': 8}
  },
  'ClassData': {
  ...
  'TokenData': {'deposit': 'Balance', 'attributes': 'Attributes'},
  'TokenId': 'u64',
  'TokenIdOf': 'TokenId',
  'NFTClassId': 'u32',
  'ClassIdOf': 'ClassId',
...
const nomineesElection = <String, dynamic>{
  'NomineeId': 'AccountId',
...
const stakingPool = <String, dynamic>{
  'SubAccountStatus': {
    'bonded': 'Balance',
    'available': 'Balance',
  ...
  'ChangeRate': {
    '_enum': {'NoChange': 'Null', 'NewValue': 'Rate'}
  },
  'ChangeRatio': {
    '_enum': {'NoChange': 'Null', 'NewValue': 'Ratio'}
  },
...
const support = <String, dynamic>{
  'ExchangeRate': 'FixedU128',
  'Rate': 'FixedU128',
  'Ratio': 'FixedU128'
};

const renvmBridge = <String, dynamic>{
  'PublicKey': '[u8; 20]',
  'DestAddress': 'Vec<u8>'
};

const stableAsset = <String, dynamic>{
  'PoolTokenIndex': 'u32',
  'AssetId': 'CurrencyId'
};
...
const alias = {
  ...
  'stakingPool': {'Phase': 'StakingPoolPhase'},
  'nomineesElection': {'UnlockChunk': 'HomaUnlockChunk'}
};
...
var bundle = <String, dynamic>{
  ...
  'versions': [
    ...
    {
      'minmax': [1008, 1009],
      'types': {...addressV1, ...xcmV0, ...poolIdV1}
    },
    {
      'minmax': [1010, 1013],
      'types': {...addressV1, ...xcmV0}
    },
    {
      'minmax': [1014, 1018],
      'types': {...addressV1, ...xcmV1}
    },
    {
      'minmax': [1019, null],
      'types': {...addressV1}
  ...
  'signedExtensions': {'SetEvmOrigin': 'Null'}
};
