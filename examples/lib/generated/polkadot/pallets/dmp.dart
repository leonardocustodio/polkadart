...
class Queries {
  ...
  /// Returns the storage key for `downwardMessageQueueHeads`.
  _i8.Uint8List downwardMessageQueueHeadsKey(_i2.Id key1) {
    final hashedKey = _downwardMessageQueueHeads.hashedKeyFor(key1);
    return hashedKey;
  }

  /// Returns the storage key for `deliveryFeeFactor`.
  _i8.Uint8List deliveryFeeFactorKey(_i2.Id key1) {
    final hashedKey = _deliveryFeeFactor.hashedKeyFor(key1);
    return hashedKey;
  }

  /// Returns the storage map key prefix for `downwardMessageQueues`.
  _i8.Uint8List downwardMessageQueuesMapPrefix() {
    final hashedKey = _downwardMessageQueues.mapPrefix();
    return hashedKey;
  }

  /// Returns the storage map key prefix for `downwardMessageQueueHeads`.
  _i8.Uint8List downwardMessageQueueHeadsMapPrefix() {
    final hashedKey = _downwardMessageQueueHeads.mapPrefix();
    return hashedKey;
  }

  /// Returns the storage map key prefix for `deliveryFeeFactor`.
  _i8.Uint8List deliveryFeeFactorMapPrefix() {
