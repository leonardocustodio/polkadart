...
import '../types/pallet_election_provider_multi_phase/pallet/call.dart' as _i14;
import '../types/pallet_election_provider_multi_phase/phase.dart' as _i3;
import '../types/pallet_election_provider_multi_phase/raw_solution.dart'
    as _i13;
...
import '../types/sp_arithmetic/per_things/perbill.dart' as _i17;
import '../types/sp_core/crypto/account_id32.dart' as _i15;
import '../types/sp_npos_elections/election_score.dart' as _i8;
import '../types/sp_npos_elections/support.dart' as _i16;
import '../types/sp_weights/weight_v2/weight.dart' as _i18;
...
class Queries {
  ...
  _i11.Uint8List currentPhaseKey() {
    final hashedKey = _currentPhase.hashedKey();
    return hashedKey;
  }

  /// Returns the storage key for `queuedSolution`.
  _i11.Uint8List queuedSolutionKey() {
    final hashedKey = _queuedSolution.hashedKey();
    return hashedKey;
  }

  /// Returns the storage key for `snapshot`.
  _i11.Uint8List snapshotKey() {
    final hashedKey = _snapshot.hashedKey();
    return hashedKey;
  }

  /// Returns the storage key for `desiredTargets`.
  _i11.Uint8List desiredTargetsKey() {
    final hashedKey = _desiredTargets.hashedKey();
    return hashedKey;
  }

  /// Returns the storage key for `snapshotMetadata`.
  _i11.Uint8List snapshotMetadataKey() {
    final hashedKey = _snapshotMetadata.hashedKey();
    return hashedKey;
  }

  /// Returns the storage key for `signedSubmissionNextIndex`.
  _i11.Uint8List signedSubmissionNextIndexKey() {
    final hashedKey = _signedSubmissionNextIndex.hashedKey();
    return hashedKey;
  }

  /// Returns the storage key for `signedSubmissionIndices`.
  _i11.Uint8List signedSubmissionIndicesKey() {
    final hashedKey = _signedSubmissionIndices.hashedKey();
    return hashedKey;
  }

  /// Returns the storage key for `signedSubmissionsMap`.
  _i11.Uint8List signedSubmissionsMapKey(int key1) {
    final hashedKey = _signedSubmissionsMap.hashedKeyFor(key1);
    return hashedKey;
  }

  /// Returns the storage key for `minimumUntrustedScore`.
  _i11.Uint8List minimumUntrustedScoreKey() {
    final hashedKey = _minimumUntrustedScore.hashedKey();
    return hashedKey;
  }

  /// Returns the storage map key prefix for `signedSubmissionsMap`.
  _i11.Uint8List signedSubmissionsMapMapPrefix() {
    final hashedKey = _signedSubmissionsMap.mapPrefix();
    return hashedKey;
  }
}
...
class Txs {
  ...
  _i12.RuntimeCall submitUnsigned({
    required _i13.RawSolution rawSolution,
    required _i6.SolutionOrSnapshotSize witness,
  }) {
    final _call = _i14.Call.values.submitUnsigned(
      rawSolution: rawSolution,
      witness: witness,
    );
    return _i12.RuntimeCall.values.electionProviderMultiPhase(_call);
  }
  ...
  _i12.RuntimeCall setMinimumUntrustedScore(
  ...
  _i12.RuntimeCall setEmergencyElectionResult(
      {required List<_i7.Tuple2<_i15.AccountId32, _i16.Support>> supports}) {
    final _call =
        _i14.Call.values.setEmergencyElectionResult(supports: supports);
    return _i12.RuntimeCall.values.electionProviderMultiPhase(_call);
  }
  ...
  _i12.RuntimeCall submit({required _i13.RawSolution rawSolution}) {
    final _call = _i14.Call.values.submit(rawSolution: rawSolution);
    return _i12.RuntimeCall.values.electionProviderMultiPhase(_call);
  }
  ...
  _i12.RuntimeCall governanceFallback({
    int? maybeMaxVoters,
    int? maybeMaxTargets,
  }) {
    final _call = _i14.Call.values.governanceFallback(
