...
class Txs {
  ...
  /// ## Complexity
  /// - `O(1)`.
  _i7.RuntimeCall claim({required int index}) {
    final _call = _i8.Call.values.claim(index: index);
    return _i7.RuntimeCall.values.indices(_call);
  }
  ...
  /// ## Complexity
  /// - `O(1)`.
  _i7.RuntimeCall free({required int index}) {
    final _call = _i8.Call.values.free(index: index);
    return _i7.RuntimeCall.values.indices(_call);
  }
  ...
  /// ## Complexity
  /// - `O(1)`.
  _i7.RuntimeCall forceTransfer({
    required _i9.MultiAddress new_,
    required int index,
    required bool freeze,
  }) {
    final _call = _i8.Call.values.forceTransfer(
      new_: new_,
      index: index,
      freeze: freeze,
    );
  ...
  /// ## Complexity
  /// - `O(1)`.
  _i7.RuntimeCall freeze({required int index}) {
    final _call = _i8.Call.values.freeze(index: index);
    return _i7.RuntimeCall.values.indices(_call);
  }
}
