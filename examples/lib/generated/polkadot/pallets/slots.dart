...
class Txs {
  ...
  _i8.RuntimeCall forceLease({
    ...
    final _call = _i9.Call.values.forceLease(
      para: para,
      leaser: leaser,
      amount: amount,
    ...
    return _i8.RuntimeCall.values.slots(_call);
  }

  /// Clear all leases for a Para Id, refunding any deposits back to the original owners.
  ///
  /// The dispatch origin for this call must match `T::ForceOrigin`.
  _i8.RuntimeCall clearAllLeases({required _i2.Id para}) {
    final _call = _i9.Call.values.clearAllLeases(para: para);
    return _i8.RuntimeCall.values.slots(_call);
  }
  ...
  _i8.RuntimeCall triggerOnboard({required _i2.Id para}) {
    final _call = _i9.Call.values.triggerOnboard(para: para);
    return _i8.RuntimeCall.values.slots(_call);
  }
}
