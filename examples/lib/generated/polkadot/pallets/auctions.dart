...
import '../types/polkadot_runtime_common/auctions/pallet/call.dart' as _i10;
...
class Queries {
  ...
  /// Returns the storage key for `auctionInfo`.
  _i8.Uint8List auctionInfoKey() {
    final hashedKey = _auctionInfo.hashedKey();
    return hashedKey;
  }

  /// Returns the storage key for `reservedAmounts`.
  _i8.Uint8List reservedAmountsKey(_i4.Tuple2<_i5.AccountId32, _i6.Id> key1) {
    final hashedKey = _reservedAmounts.hashedKeyFor(key1);
    return hashedKey;
  }

  /// Returns the storage key for `winning`.
  _i8.Uint8List winningKey(int key1) {
    final hashedKey = _winning.hashedKeyFor(key1);
    return hashedKey;
  }

  /// Returns the storage map key prefix for `reservedAmounts`.
  _i8.Uint8List reservedAmountsMapPrefix() {
    final hashedKey = _reservedAmounts.mapPrefix();
    return hashedKey;
  }

  /// Returns the storage map key prefix for `winning`.
  _i8.Uint8List winningMapPrefix() {
    final hashedKey = _winning.mapPrefix();
    return hashedKey;
  }
}
...
class Txs {
  ...
  _i9.RuntimeCall newAuction({
    required BigInt duration,
    required BigInt leasePeriodIndex,
  }) {
    final _call = _i10.Call.values.newAuction(
      duration: duration,
      leasePeriodIndex: leasePeriodIndex,
    );
    return _i9.RuntimeCall.values.auctions(_call);
  }
  ...
  _i9.RuntimeCall bid({
    ...
    final _call = _i10.Call.values.bid(
      para: para,
  ...
  _i9.RuntimeCall cancelAuction() {
    final _call = _i10.Call.values.cancelAuction();
    return _i9.RuntimeCall.values.auctions(_call);
  }
}
