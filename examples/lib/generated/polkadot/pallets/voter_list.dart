...
class Txs {
  ...
  _i8.RuntimeCall rebag({required _i9.MultiAddress dislocated}) {
    final _call = _i10.Call.values.rebag(dislocated: dislocated);
    return _i8.RuntimeCall.values.voterList(_call);
  }
  ...
  _i8.RuntimeCall putInFrontOf({required _i9.MultiAddress lighter}) {
    final _call = _i10.Call.values.putInFrontOf(lighter: lighter);
    return _i8.RuntimeCall.values.voterList(_call);
  }
  ...
  _i8.RuntimeCall putInFrontOfOther({
    required _i9.MultiAddress heavier,
    required _i9.MultiAddress lighter,
  }) {
    final _call = _i10.Call.values.putInFrontOfOther(
      heavier: heavier,
      lighter: lighter,
    );
    return _i8.RuntimeCall.values.voterList(_call);
