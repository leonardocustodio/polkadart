...
class Queries {
  ...
  /// Returns the storage key for `hasInitialized`.
  _i5.Uint8List hasInitializedKey() {
    final hashedKey = _hasInitialized.hashedKey();
    return hashedKey;
  }

  /// Returns the storage key for `bufferedSessionChanges`.
  _i5.Uint8List bufferedSessionChangesKey() {
    final hashedKey = _bufferedSessionChanges.hashedKey();
    return hashedKey;
  }
}
...
class Txs {
  ...
  _i6.RuntimeCall forceApprove({required int upTo}) {
    final _call = _i7.Call.values.forceApprove(upTo: upTo);
    return _i6.RuntimeCall.values.initializer(_call);
  }
}
