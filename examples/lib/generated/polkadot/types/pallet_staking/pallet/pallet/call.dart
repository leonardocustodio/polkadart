...
import '../../unlock_chunk.dart' as _i13;
...
class $Call {
  ...
  SetStakingConfigs setStakingConfigs({
    ...
    required _i10.ConfigOp maxStakedRewards,
  }) {
  ...
  ChillOther chillOther({required _i7.AccountId32 stash}) {
    return ChillOther(stash: stash);
  }
  ...
  UpdatePayee updatePayee({required _i7.AccountId32 controller}) {
    return UpdatePayee(controller: controller);
  }

  DeprecateControllerBatch deprecateControllerBatch(
      {required List<_i7.AccountId32> controllers}) {
    return DeprecateControllerBatch(controllers: controllers);
  }

  RestoreLedger restoreLedger({
    required _i7.AccountId32 stash,
    _i7.AccountId32? maybeController,
    BigInt? maybeTotal,
    List<_i13.UnlockChunk>? maybeUnlocking,
  }) {
...
class $CallCodec with _i1.Codec<Call> {
  ...
  Call decode(_i1.Input input) {
    ...
    switch (index) {
      ...
      case 26:
        return PayoutStakersByPage._decode(input);
      case 27:
        return UpdatePayee._decode(input);
      case 28:
  ...
  void encodeTo(
    ...
    switch (value.runtimeType) {
      ...
      case SetMinCommission:
        ...
        break;
      case PayoutStakersByPage:
        (value as PayoutStakersByPage).encodeTo(output);
        break;
      case UpdatePayee:
        (value as UpdatePayee).encodeTo(output);
        break;
      case DeprecateControllerBatch:
        (value as DeprecateControllerBatch).encodeTo(output);
        break;
      case RestoreLedger:
  ...
  int sizeHint(Call value) {
    switch (value.runtimeType) {
      ...
      case PayoutStakersByPage:
        return (value as PayoutStakersByPage)._sizeHint();
      case UpdatePayee:
        return (value as UpdatePayee)._sizeHint();
      case DeprecateControllerBatch:
...
class SetStakingConfigs extends Call {
  const SetStakingConfigs({
    ...
    required this.maxStakedRewards,
  });
  ...
  factory SetStakingConfigs._decode(_i1.Input input) {
    return SetStakingConfigs(
      ...
      maxStakedRewards: _i10.ConfigOp.codec.decode(input),
    );
  }
  ...
  /// ConfigOp<Percent>
  final _i10.ConfigOp maxStakedRewards;
  ...
  Map<String, Map<String, Map<String, dynamic>>> toJson() => {
        'set_staking_configs': {
          ...
          'maxStakedRewards': maxStakedRewards.toJson(),
        }
      };
  ...
  int _sizeHint() {
    ...
    size = size + _i10.ConfigOp.codec.sizeHint(maxStakedRewards);
    return size;
  }
  ...
  bool operator ==(Object other) =>
      ...
      other is SetStakingConfigs &&
          ...
          other.maxStakedRewards == maxStakedRewards;
...
class ChillOther extends Call {
  const ChillOther({required this.stash});

  factory ChillOther._decode(_i1.Input input) {
    return ChillOther(stash: const _i1.U8ArrayCodec(32).decode(input));
  }
  ...
  Map<String, Map<String, List<int>>> toJson() => {
        'chill_other': {'stash': stash.toList()}
      };
...
class PayoutStakersByPage extends Call {
  ...
  factory PayoutStakersByPage._decode(_i1.Input input) {
    return PayoutStakersByPage(
      validatorStash: const _i1.U8ArrayCodec(32).decode(input),
      era: _i1.U32Codec.codec.decode(input),
...
class UpdatePayee extends Call {
  const UpdatePayee({required this.controller});

  factory UpdatePayee._decode(_i1.Input input) {
    return UpdatePayee(controller: const _i1.U8ArrayCodec(32).decode(input));
  }
  ...
  @override
  Map<String, Map<String, List<int>>> toJson() => {
        'update_payee': {'controller': controller.toList()}
      };
...
class DeprecateControllerBatch extends Call {
  const DeprecateControllerBatch({required this.controllers});

  factory DeprecateControllerBatch._decode(_i1.Input input) {
    return DeprecateControllerBatch(
        controllers:
            const _i1.SequenceCodec<_i7.AccountId32>(_i7.AccountId32Codec())
                .decode(input));
  }
  ...
  final List<_i7.AccountId32> controllers;
  ...
  bool operator ==(Object other) =>
      ...
      other is DeprecateControllerBatch &&
          _i14.listsEqual(
            other.controllers,
            controllers,
          );
  ...
  @override
  int get hashCode => controllers.hashCode;
}
...
class RestoreLedger extends Call {
  const RestoreLedger({
    required this.stash,
    this.maybeController,
    this.maybeTotal,
    this.maybeUnlocking,
  });

  factory RestoreLedger._decode(_i1.Input input) {
    return RestoreLedger(
      stash: const _i1.U8ArrayCodec(32).decode(input),
      maybeController:
          const _i1.OptionCodec<_i7.AccountId32>(_i7.AccountId32Codec())
              .decode(input),
      maybeTotal:
          const _i1.OptionCodec<BigInt>(_i1.U128Codec.codec).decode(input),
      maybeUnlocking: const _i1.OptionCodec<List<_i13.UnlockChunk>>(
              _i1.SequenceCodec<_i13.UnlockChunk>(_i13.UnlockChunk.codec))
          .decode(input),
    );
  }
  ...
  /// Option<T::AccountId>
  final _i7.AccountId32? maybeController;

  /// Option<BalanceOf<T>>
  final BigInt? maybeTotal;

  /// Option<BoundedVec<UnlockChunk<BalanceOf<T>>, T::
  ///MaxUnlockingChunks>>
  final List<_i13.UnlockChunk>? maybeUnlocking;

  @override
  Map<String, Map<String, dynamic>> toJson() => {
        'restore_ledger': {
          'stash': stash.toList(),
          'maybeController': maybeController?.toList(),
          'maybeTotal': maybeTotal,
          'maybeUnlocking':
              maybeUnlocking?.map((value) => value.toJson()).toList(),
        }
      };
  ...
  int _sizeHint() {
    ...
    size = size +
        const _i1.OptionCodec<_i7.AccountId32>(_i7.AccountId32Codec())
            .sizeHint(maybeController);
    size = size +
        const _i1.OptionCodec<BigInt>(_i1.U128Codec.codec).sizeHint(maybeTotal);
    size = size +
        const _i1.OptionCodec<List<_i13.UnlockChunk>>(
                _i1.SequenceCodec<_i13.UnlockChunk>(_i13.UnlockChunk.codec))
            .sizeHint(maybeUnlocking);
    return size;
  }
  ...
  void encodeTo(_i1.Output output) {
    ...
    const _i1.OptionCodec<_i7.AccountId32>(_i7.AccountId32Codec()).encodeTo(
      maybeController,
      output,
    );
  ...
  bool operator ==(Object other) =>
      ...
      other is RestoreLedger &&
          _i14.listsEqual(
            other.stash,
            stash,
          ) &&
          other.maybeController == maybeController &&
          other.maybeTotal == maybeTotal &&
          other.maybeUnlocking == maybeUnlocking;
