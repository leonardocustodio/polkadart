...
import '../../../../polkadot_runtime/runtime_freeze_reason.dart' as _i2;
...
class IdAmount {
  ...
  /// Id
  final _i2.RuntimeFreezeReason id;
...
class $IdAmountCodec with _i1.Codec<IdAmount> {
  ...
  void encodeTo(
    ...
    _i2.RuntimeFreezeReason.codec.encodeTo(
      obj.id,
      output,
    );
  ...
  IdAmount decode(_i1.Input input) {
    return IdAmount(
      id: _i2.RuntimeFreezeReason.codec.decode(input),
  ...
  int sizeHint(IdAmount obj) {
    int size = 0;
    size = size + _i2.RuntimeFreezeReason.codec.sizeHint(obj.id);
