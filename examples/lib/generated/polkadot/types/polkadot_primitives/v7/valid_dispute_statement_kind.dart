...
import '../../polkadot_core_primitives/candidate_hash.dart' as _i4;
...
class $ValidDisputeStatementKind {
  ...
  ApprovalCheckingMultipleCandidates approvalCheckingMultipleCandidates(
      List<_i4.CandidateHash> value0) {
    return ApprovalCheckingMultipleCandidates(value0);
  }
}
...
class $ValidDisputeStatementKindCodec
  ...
  ValidDisputeStatementKind decode(_i1.Input input) {
    ...
    switch (index) {
      ...
      case 4:
        return ApprovalCheckingMultipleCandidates._decode(input);
      default:
        throw Exception(
  ...
  void encodeTo(
    ...
    switch (value.runtimeType) {
      ...
      case ApprovalCheckingMultipleCandidates:
        (value as ApprovalCheckingMultipleCandidates).encodeTo(output);
        break;
      default:
        throw Exception(
  ...
  int sizeHint(ValidDisputeStatementKind value) {
    switch (value.runtimeType) {
      ...
      case ApprovalChecking:
        return 1;
      case ApprovalCheckingMultipleCandidates:
        return (value as ApprovalCheckingMultipleCandidates)._sizeHint();
      default:
        throw Exception(
            'ValidDisputeStatementKind: Unsupported "$value" of type "${value.runtimeType}"');
    }
...
class ApprovalCheckingMultipleCandidates extends ValidDisputeStatementKind {
  const ApprovalCheckingMultipleCandidates(this.value0);

  factory ApprovalCheckingMultipleCandidates._decode(_i1.Input input) {
    return ApprovalCheckingMultipleCandidates(
        const _i1.SequenceCodec<_i4.CandidateHash>(_i4.CandidateHashCodec())
            .decode(input));
  }

  /// Vec<CandidateHash>
  final List<_i4.CandidateHash> value0;

  @override
  Map<String, List<List<int>>> toJson() => {
        'ApprovalCheckingMultipleCandidates':
            value0.map((value) => value.toList()).toList()
      };
  ...
  bool operator ==(Object other) =>
      ...
      other is ApprovalCheckingMultipleCandidates &&
          _i5.listsEqual(
            other.value0,
            value0,
          );
