...
class $Event {
  ...
  ProcessingFailed processingFailed({
    ...
    required _i4.AggregateMessageOrigin origin,
...
class ProcessingFailed extends Event {
  ...
  factory ProcessingFailed._decode(_i1.Input input) {
    return ProcessingFailed(
      ...
      origin: _i4.AggregateMessageOrigin.codec.decode(input),
  ...
  final _i4.AggregateMessageOrigin origin;
  ...
  int _sizeHint() {
    ...
    size = size + _i4.AggregateMessageOrigin.codec.sizeHint(origin);
  ...
  void encodeTo(_i1.Output output) {
    ...
    _i4.AggregateMessageOrigin.codec.encodeTo(
      origin,
      output,
    );
