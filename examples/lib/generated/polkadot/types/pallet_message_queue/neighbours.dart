...
import '../polkadot_runtime_parachains/inclusion/aggregate_message_origin.dart'
    as _i2;
...
class Neighbours {
  ...
  /// MessageOrigin
  final _i2.AggregateMessageOrigin prev;

  /// MessageOrigin
  final _i2.AggregateMessageOrigin next;
...
class $NeighboursCodec with _i1.Codec<Neighbours> {
  ...
  void encodeTo(
    ...
    _i2.AggregateMessageOrigin.codec.encodeTo(
      obj.prev,
      output,
    );
    _i2.AggregateMessageOrigin.codec.encodeTo(
  ...
  Neighbours decode(_i1.Input input) {
    return Neighbours(
      prev: _i2.AggregateMessageOrigin.codec.decode(input),
      next: _i2.AggregateMessageOrigin.codec.decode(input),
    );
  }
  ...
  int sizeHint(Neighbours obj) {
    int size = 0;
    size = size + _i2.AggregateMessageOrigin.codec.sizeHint(obj.prev);
