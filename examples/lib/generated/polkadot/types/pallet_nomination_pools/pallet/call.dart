...
import '../commission_claim_permission.dart' as _i15;
...
class $Call {
  ...
  AdjustPoolDeposit adjustPoolDeposit({required int poolId}) {
    return AdjustPoolDeposit(poolId: poolId);
  }

  SetCommissionClaimPermission setCommissionClaimPermission({
    required int poolId,
    _i15.CommissionClaimPermission? permission,
  }) {
    return SetCommissionClaimPermission(
      poolId: poolId,
      permission: permission,
    );
  }

  ApplySlash applySlash({required _i4.MultiAddress memberAccount}) {
    return ApplySlash(memberAccount: memberAccount);
  }

  MigrateDelegation migrateDelegation(
      {required _i4.MultiAddress memberAccount}) {
    return MigrateDelegation(memberAccount: memberAccount);
  }

  MigratePoolToDelegateStake migratePoolToDelegateStake({required int poolId}) {
    return MigratePoolToDelegateStake(poolId: poolId);
  }
}
...
class $CallCodec with _i1.Codec<Call> {
  ...
  Call decode(_i1.Input input) {
    ...
    switch (index) {
      ...
      case 21:
        return AdjustPoolDeposit._decode(input);
      case 22:
        return SetCommissionClaimPermission._decode(input);
      case 23:
        return ApplySlash._decode(input);
      case 24:
        return MigrateDelegation._decode(input);
      case 25:
        return MigratePoolToDelegateStake._decode(input);
      default:
  ...
  void encodeTo(
    ...
    switch (value.runtimeType) {
      ...
      case ClaimCommission:
        ...
        break;
      case AdjustPoolDeposit:
        (value as AdjustPoolDeposit).encodeTo(output);
        break;
      case SetCommissionClaimPermission:
        (value as SetCommissionClaimPermission).encodeTo(output);
        break;
      case ApplySlash:
        (value as ApplySlash).encodeTo(output);
        break;
      case MigrateDelegation:
        (value as MigrateDelegation).encodeTo(output);
        break;
      case MigratePoolToDelegateStake:
        (value as MigratePoolToDelegateStake).encodeTo(output);
        break;
      default:
        throw Exception(
  ...
  int sizeHint(Call value) {
    switch (value.runtimeType) {
      ...
      case AdjustPoolDeposit:
        return (value as AdjustPoolDeposit)._sizeHint();
      case SetCommissionClaimPermission:
        return (value as SetCommissionClaimPermission)._sizeHint();
      case ApplySlash:
        return (value as ApplySlash)._sizeHint();
      case MigrateDelegation:
        return (value as MigrateDelegation)._sizeHint();
      case MigratePoolToDelegateStake:
        return (value as MigratePoolToDelegateStake)._sizeHint();
      default:
        throw Exception(
            'Call: Unsupported "$value" of type "${value.runtimeType}"');
    }
...
class AdjustPoolDeposit extends Call {
  const AdjustPoolDeposit({required this.poolId});

  factory AdjustPoolDeposit._decode(_i1.Input input) {
    return AdjustPoolDeposit(poolId: _i1.U32Codec.codec.decode(input));
  }
  ...
  @override
  Map<String, Map<String, int>> toJson() => {
        'adjust_pool_deposit': {'poolId': poolId}
      };
  ...
  bool operator ==(Object other) =>
      ...
      other is AdjustPoolDeposit && other.poolId == poolId;
...
class SetCommissionClaimPermission extends Call {
  const SetCommissionClaimPermission({
    required this.poolId,
    this.permission,
  });

  factory SetCommissionClaimPermission._decode(_i1.Input input) {
    return SetCommissionClaimPermission(
      poolId: _i1.U32Codec.codec.decode(input),
      permission: const _i1.OptionCodec<_i15.CommissionClaimPermission>(
              _i15.CommissionClaimPermission.codec)
          .decode(input),
    );
  }
  ...
  final _i15.CommissionClaimPermission? permission;
  ...
  int _sizeHint() {
    ...
    size = size + _i1.U32Codec.codec.sizeHint(poolId);
    size = size +
        const _i1.OptionCodec<_i15.CommissionClaimPermission>(
                _i15.CommissionClaimPermission.codec)
            .sizeHint(permission);
    return size;
  }
  ...
  bool operator ==(Object other) =>
      ...
      other is SetCommissionClaimPermission &&
          other.poolId == poolId &&
...
class ApplySlash extends Call {
  const ApplySlash({required this.memberAccount});

  factory ApplySlash._decode(_i1.Input input) {
    return ApplySlash(memberAccount: _i4.MultiAddress.codec.decode(input));
  }
  ...
  @override
  Map<String, Map<String, Map<String, dynamic>>> toJson() => {
        'apply_slash': {'memberAccount': memberAccount.toJson()}
      };
  ...
  bool operator ==(Object other) =>
      ...
      other is ApplySlash && other.memberAccount == memberAccount;

  @override
  int get hashCode => memberAccount.hashCode;
}
...
class MigrateDelegation extends Call {
  const MigrateDelegation({required this.memberAccount});

  factory MigrateDelegation._decode(_i1.Input input) {
    return MigrateDelegation(
        memberAccount: _i4.MultiAddress.codec.decode(input));
  }
  ...
  @override
  Map<String, Map<String, Map<String, dynamic>>> toJson() => {
        'migrate_delegation': {'memberAccount': memberAccount.toJson()}
      };
  ...
  bool operator ==(Object other) =>
      ...
      other is MigrateDelegation && other.memberAccount == memberAccount;
...
class MigratePoolToDelegateStake extends Call {
  const MigratePoolToDelegateStake({required this.poolId});

  factory MigratePoolToDelegateStake._decode(_i1.Input input) {
    return MigratePoolToDelegateStake(poolId: _i1.U32Codec.codec.decode(input));
  }
  ...
  @override
  Map<String, Map<String, int>> toJson() => {
        'migrate_pool_to_delegate_stake': {'poolId': poolId}
      };
  ...
  bool operator ==(Object other) =>
      ...
      other is MigratePoolToDelegateStake && other.poolId == poolId;
