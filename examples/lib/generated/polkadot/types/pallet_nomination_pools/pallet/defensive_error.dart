...
enum DefensiveError {
  ...
  delegationUnsupported('DelegationUnsupported', 5),
  slashNotApplied('SlashNotApplied', 6);
...
class $DefensiveErrorCodec with _i1.Codec<DefensiveError> {
  ...
  DefensiveError decode(_i1.Input input) {
    ...
    switch (index) {
      ...
      case 5:
        return DefensiveError.delegationUnsupported;
      case 6:
        return DefensiveError.slashNotApplied;
      default:
