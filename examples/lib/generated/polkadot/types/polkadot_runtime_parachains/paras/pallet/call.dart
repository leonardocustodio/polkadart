...
import '../../../polkadot_parachain_primitives/primitives/validation_code_hash.dart'
    as _i6;
import '../../../polkadot_primitives/v7/pvf_check_statement.dart' as _i7;
import '../../../polkadot_primitives/v7/validator_app/signature.dart' as _i8;
...
class $Call {
  ...
  ForceSetMostRecentContext forceSetMostRecentContext({
    required _i3.Id para,
    required int context,
  }) {
    return ForceSetMostRecentContext(
      para: para,
      context: context,
    );
  }
...
class $CallCodec with _i1.Codec<Call> {
  ...
  Call decode(_i1.Input input) {
    ...
    switch (index) {
      ...
      case 8:
        return ForceSetMostRecentContext._decode(input);
      default:
  ...
  void encodeTo(
    ...
    switch (value.runtimeType) {
      ...
      case IncludePvfCheckStatement:
        ...
        break;
      case ForceSetMostRecentContext:
        (value as ForceSetMostRecentContext).encodeTo(output);
        break;
      default:
        throw Exception(
  ...
  int sizeHint(Call value) {
    switch (value.runtimeType) {
      ...
      case ForceSetMostRecentContext:
        return (value as ForceSetMostRecentContext)._sizeHint();
      default:
        throw Exception(
            'Call: Unsupported "$value" of type "${value.runtimeType}"');
    }
...
/// Set the storage for the current parachain head data immediately.
class ForceSetMostRecentContext extends Call {
  const ForceSetMostRecentContext({
    required this.para,
    required this.context,
  });

  factory ForceSetMostRecentContext._decode(_i1.Input input) {
    return ForceSetMostRecentContext(
      para: _i1.U32Codec.codec.decode(input),
  ...
  bool operator ==(Object other) =>
      ...
      other is ForceSetMostRecentContext &&
          other.para == para &&
