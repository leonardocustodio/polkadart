...
class Pending extends QueryStatus {
  ...
  factory Pending._decode(_i1.Input input) {
    return Pending(
      ...
      maybeMatchQuerier: const _i1.OptionCodec<_i3.VersionedLocation>(
              _i3.VersionedLocation.codec)
          .decode(input),
      maybeNotify:
  ...
  int _sizeHint() {
    ...
    size = size +
        const _i1.OptionCodec<_i3.VersionedLocation>(
                _i3.VersionedLocation.codec)
  ...
  void encodeTo(_i1.Output output) {
    ...
    const _i1.OptionCodec<_i3.VersionedLocation>(_i3.VersionedLocation.codec)
        .encodeTo(
      maybeMatchQuerier,
      output,
    );
